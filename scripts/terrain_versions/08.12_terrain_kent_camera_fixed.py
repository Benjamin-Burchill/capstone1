...
class CameraFixedKentTerrain(ShowBase):
    def __init__(self):
    ...
    def update_camera(self, task):
        dt = 0.016  # Fixed delta time for consistent movement (can be improved later)
